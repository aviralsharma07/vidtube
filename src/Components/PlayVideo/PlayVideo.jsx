...
const PlayVideo = ({ videoId }) => {
  ...
  const fetchChannelData = async () => {
    ...
    const comments_url = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet&maxResults=100&videoId=${videoId}&key=${API_KEY}`;
  ...
  return (
    <div className="play-video">
      ...
      <div className="play-video-info">
        ...
        <div>
          <span>
            <img src={like} alt="" /> {apiData ? value_converter(apiData.statistics.likeCount) : 173}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="publisher">
        ...
        <div>
          ...
          <span>{channelData ? value_converter(channelData.statistics.subscriberCount) : 747} Subscribers</span>
        </div>
      ...
      <div className="vid-description">
        ...
        <hr />
        <h4>{apiData ? value_converter(apiData.statistics.commentCount) : 133} Comments</h4>
